    ...
    <v-main>
        ...
        <div>
            <p class="center description">
                サイトのURLが変わります。<br />新しいサイトはこちら<br />
            </p>
            <a
                class="center  description"
                style="text-decoration: underline"
                href="https://machitabi103.stars.ne.jp/"
                >https://machitabi103.stars.ne.jp/</a
            >
        </div>
        ...
        <span>
            ...
            <div class="about-inline about-inline-right">
                <p>合同会社まちたびデザイン<br />Machitabi Design LLC.</p>
            </div>
        </span>
        <span>
            <v-spacer style="margin: 15px"></v-spacer>
        ...
        <span>
            ...
            <div class="about-inline about-inline-right">
                <p>
                    岐阜県多治見市出身 <br />新卒で建設コンサルタント会社に就職
                    <br />7年間公園や公共空間の計画・設計をメインに
                    <br />住民主体のまちづくりを実施
                    <br />技術士(建設部門・都市及び地方計画)を取得
                    <br />退社後に7ヶ月間の世界一周ひとり旅を経験
                    <br />帰国後に合同会社まちたびデザインを設立
                </p>
            </div>
        </span>
        <span>
